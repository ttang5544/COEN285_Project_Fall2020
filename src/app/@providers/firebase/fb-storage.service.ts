...
import { USER_ID } from '../../@shared/injection-tokens';
import { ImageStorageService } from '../service-interfaces';
...
// })
@Injectable()
export class FirebaseStorageService extends ImageStorageService {
